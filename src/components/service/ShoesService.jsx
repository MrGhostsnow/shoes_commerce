...
export const ShoesService = {
    ...
    getById: (id) => fetch(Api.shoesById(id), {method: 'GET'}).then(parseResponse),

    create: (shoes) => fetch(Api.shoesCL(),{
        method: "POST",
        headers: {
    ...
    updateById: (id) => fetch(Api.FindById(), {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    deleteById: (id) => fetch(Api.FindByById(), {method: 'DELETE'}.then(parseResponse)),
}
